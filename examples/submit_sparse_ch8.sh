...
#SBATCH --job-name=sparse_ch8
#SBATCH --output=logs/sparse_ch8_%j.out
#SBATCH --error=logs/sparse_ch8_%j.err

set -euo pipefail

# ===========================================================================
# Channel sweep: sparse pruning + sparse RS, NCCL channels pinned to 8
...
TRAIN_ITERS=20
SEED=42
NCHANNELS=8   # pinned channel count for this sweep point
# ===========================================================================

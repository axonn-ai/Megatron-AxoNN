...
#SBATCH --job-name=sparse_ch16
#SBATCH --output=logs/sparse_ch16_%j.out
#SBATCH --error=logs/sparse_ch16_%j.err

set -euo pipefail

# ===========================================================================
# Channel sweep: sparse pruning + sparse RS, NCCL channels pinned to 16
...
TRAIN_ITERS=20
SEED=42
NCHANNELS=16   # pinned channel count for this sweep point
# ===========================================================================

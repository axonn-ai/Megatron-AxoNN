...
#SBATCH --job-name=dense_shim
#SBATCH --output=logs/dense_shim_%j.out
#SBATCH --error=logs/dense_shim_%j.err
...
TB_DIR="$SCRIPT_DIR/tensorboard/${SLURM_JOB_ID}_${MODEL}_${MODE}_dense_ncclx_autoch"
mkdir -p "$TB_DIR"

...
#SBATCH --job-name=sparse_ch2
#SBATCH --output=logs/sparse_ch2_%j.out
#SBATCH --error=logs/sparse_ch2_%j.err

set -euo pipefail

# ===========================================================================
# Channel sweep: sparse pruning + sparse RS, NCCL channels pinned to 2
...
TRAIN_ITERS=20
SEED=42
NCHANNELS=2   # pinned channel count for this sweep point
# ===========================================================================

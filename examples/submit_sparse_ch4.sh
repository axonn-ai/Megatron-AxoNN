...
#SBATCH --job-name=sparse_ch4
#SBATCH --output=logs/sparse_ch4_%j.out
#SBATCH --error=logs/sparse_ch4_%j.err

set -euo pipefail

# ===========================================================================
# Channel sweep: sparse pruning + sparse RS, NCCL channels pinned to 4
...
TRAIN_ITERS=20
SEED=42
NCHANNELS=4   # pinned channel count for this sweep point
# ===========================================================================
